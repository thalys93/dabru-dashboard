import { Bank, CaretLeft, CaretRight, ChartLine, ClipboardText, Cube, DoorOpen, Gear, Info, Package, SquaresFour } from "@phosphor-icons/react"
    ...
    <section className="flex flex-col justify-start p-3 animate__animated animate__fadeInLeft h-screen w-[5rem]">
      <div className="flex flex-col gap-1">
        <div className="flex flex-row gap-2 items-center justify-center">
          <Package className="text-stone-50 text-3xl" />
        </div>
    ...
    <section className="flex flex-col justify-start p-3 animate__animated animate__fadeInLeftBig h-screen">
      <div className="flex flex-col gap-1">
        <div className="flex flex-row gap-2 items-center">
          <Package className="text-stone-50 text-3xl mb-2" />
          <span className="text-stone-50 font-bebas text-2xl select-none">EC-Gestor</span>
        </div>
        <h1 className="font-blinker text-stone-400 text-md select-none"> painel de gerenciamento de eccomerce on-line</h1>
